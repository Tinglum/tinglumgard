    ...
    <div className="min-h-screen py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl space-y-8">
        <div className="text-center space-y-3">
          <div className="mx-auto w-14 h-14 rounded-full bg-emerald-50 text-emerald-700 flex items-center justify-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link href="/rugeegg/handlekurv" className="btn-primary w-full sm:w-auto justify-center">
            {language === 'no' ? 'Til handlekurv' : 'Go to cart'}
          </Link>
        </div>
      </div>
    </div>
