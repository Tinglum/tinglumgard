...
export default async function GroceriesPage() {
  await requireTodoTwoUser(`${TODOTWO_BASE}/groceries`)
  const { project, tasks, suggestions } = await getGroceryList()
  return <div className="mx-auto flex w-full max-w-2xl flex-col gap-6">
    ...
    {project ? <GroceryList tasks={tasks} suggestions={suggestions} /> : <EmptyState title="Grocery list is being prepared" description="An admin needs to create the Grocery List project once." />}
  </div>
}
