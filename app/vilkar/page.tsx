...
export default function VilkarPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-ice/20 via-white to-slate/10 py-24 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Glass card */}
        <div className="glass-card-strong rounded-3xl p-12 border-2 border-white/80">
          {lang === 'no' ? (
            <>
              ...
              <p className="text-lg text-slate/80 mb-8 leading-relaxed">
              ...
              <section className="mb-10">
                <h2 className="text-3xl font-bold text-charcoal mb-4">1. Parter</h2>
                <div className="text-slate/80 leading-relaxed space-y-3">
                  <p><strong>Selger er:</strong></p>
              ...
              {/* 2. Betaling */}
              <section className="mb-10">
                <h2 className="text-3xl font-bold text-charcoal mb-4">2. Betaling</h2>
                <div className="text-slate/80 leading-relaxed space-y-3">
              ...
              {/* 3. Levering */}
              <section className="mb-10">
                <h2 className="text-3xl font-bold text-charcoal mb-4">3. Levering</h2>
                <div className="text-slate/80 leading-relaxed space-y-3">
              ...
              {/* 4. Angrerett */}
              <section className="mb-10">
                <h2 className="text-3xl font-bold text-charcoal mb-4">4. Angrerett</h2>
                <div className="text-slate/80 leading-relaxed space-y-3">
              ...
              {/* 5. Retur */}
              <section className="mb-10">
                <h2 className="text-3xl font-bold text-charcoal mb-4">5. Retur</h2>
                <div className="text-slate/80 leading-relaxed space-y-3">
                  <p>
              ...
              {/* 6. Reklamasjon */}
              <section className="mb-10">
                <h2 className="text-3xl font-bold text-charcoal mb-4">6. Reklamasjon</h2>
                <div className="text-slate/80 leading-relaxed space-y-3">
                  <p>
              ...
              {/* 7. Konfliktløsning */}
              <section className="mb-10">
                <h2 className="text-3xl font-bold text-charcoal mb-4">7. Konfliktløsning</h2>
                <div className="text-slate/80 leading-relaxed space-y-3">
            ...
            <>
              ...
              {/* 1. Parties */}
              <section className="mb-10">
                <h2 className="text-3xl font-bold text-charcoal mb-4">1. Parties</h2>
                <div className="text-slate/80 leading-relaxed space-y-3">
              ...
              {/* 2. Payment */}
              <section className="mb-10">
                <h2 className="text-3xl font-bold text-charcoal mb-4">2. Payment</h2>
                <div className="text-slate/80 leading-relaxed space-y-3">
              ...
              {/* 3. Delivery */}
              <section className="mb-10">
                <h2 className="text-3xl font-bold text-charcoal mb-4">3. Delivery</h2>
                <div className="text-slate/80 leading-relaxed space-y-3">
              ...
              <section className="mb-10">
                <h2 className="text-3xl font-bold text-charcoal mb-4">4. Right of Withdrawal</h2>
                <div className="text-slate/80 leading-relaxed space-y-3">
              ...
              {/* 5. Returns */}
              <section className="mb-10">
                <h2 className="text-3xl font-bold text-charcoal mb-4">5. Returns</h2>
                <div className="text-slate/80 leading-relaxed space-y-3">
                  <p>
              ...
              {/* 6. Complaints */}
              <section className="mb-10">
                <h2 className="text-3xl font-bold text-charcoal mb-4">6. Complaints</h2>
                <div className="text-slate/80 leading-relaxed space-y-3">
                  <p>
              ...
              <section className="mb-10">
                <h2 className="text-3xl font-bold text-charcoal mb-4">7. Dispute Resolution</h2>
                <div className="text-slate/80 leading-relaxed space-y-3">
