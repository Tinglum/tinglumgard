export const no = {
  ...
  hero: {
    ...
    description: "Gris fra Tinglum Gård i Namdalseid. Grisene vokser opp på gården gjennom 2026, slaktes lokalt i desember, og leveres fersk til døren din.",
    ...
    reservePackageNow: "Reserver din pakke nå",
  },

  // Product/Box selection
  product: {
    chooseYourBox: "Velg din pakke",
    choosePackage: "Velg din pakke",
    ...
    smallerPackage: "Mindre pakke",
    largeBox: "Større pakke",
    largerPackage: "Større pakke",
