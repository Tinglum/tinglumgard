export const no = {
  ...
  eggOrdersWorkbench: {
    ...
    markSent: {
      ...
      modalDescription: "Legg til sporingsnummer for Posten. Bruk format ND1234567890 eller lenke.",
      trackingLabel: "Sporingsnummer",
      trackingPlaceholder: "Skriv inn sporingsnummer...",
      formatHint: "Format: ND1234567890 eller Posten-lenke",
      cancelButton: "Avbryt",
