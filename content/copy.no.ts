export const no = {
  ...
  vippsCheckout: {
    ...
    nextStep2: "Du far en bekreftelse på e-post når forskuddet er mottatt",
  ...
  eggOrdersWorkbench: {
    ...
    panel: {
      ...
      actionReasonLabel: "Årsak for handlinger (valgfritt)",
      actionReasonPlaceholder: "Notat/årsak for handling",
