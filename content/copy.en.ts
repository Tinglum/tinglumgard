export const en = {
  ...
  browse: {
    ...
    waitlistPanelDescription: "If your preferred week is full, sold out, or the quantity is unavailable, you can add a wishlist request. We allocate manually when cancellations or overproduction happen.",
  ...
  timeline: {
    ...
    step3Desc: "The pigs are professionally slaughtered and packed fresh. Then everything is frozen for optimal shelf life and delivered in week 48.",
    step3Time: "Week 48",
    ...
    optional: "Optional",
    week44: "Week 44: Remainder payment completed",
    week46: "Week 46: Final deadline for changes",
    week48: "Week 48: Delivery and pickup",
    week44Desc: "The remainder is paid and the order is confirmed for production.",
    week46Desc: "Change size and extras until the deadline, after which the order is locked.",
    week48Desc: "Frozen pickup or delivery according to your chosen option.",
  },
  ...
  checkout: {
    ...
    referralCodeDetected: "Referral code detected: {code}",
    discountActive: "Discount active: -{amount} {currency}",
    ...
    expectedDelivery: "Expected delivery: week 48.",
  ...
  eggs: {
    ...
    errors: {
      ...
      couldNotFetchOrder: "Failed to fetch order",
        ...
        couldNotCreateCheckout: "Failed to create the order",
    ...
    breedsPage: {
      subtitle:
        "Four unique breeds with distinctive characteristics. All our chickens are free-range and fed quality feed.",
      ...
      activeOrderPrompt: {
        ...
        existingOrderTitle: "You already have an order for this week",
        existingOrderDescription: "Do you want to add these eggs to the existing order and avoid paying shipping again?",
        orderWithoutName: "Order without name",
        eggsAlreadyOrdered: "{count} eggs already ordered",
        addToExistingOrder: "Add to existing order",
        createNewOrder: "Create a new order",
        duplicateWarningTitle: "Are you sure you want a new order?",
        duplicateWarningDescription: "You already have an order for week {week}. A new order means a separate shipment and shipping cost.",
        backToExistingOrder: "Back to existing order",
        confirmDuplicateOrder: "Yes, create new order",
      },
    cart: {
      title: "Shopping Cart",
    ...
    myOrders: {
      ...
      addEggs: "Add eggs",
      timeline: "Timeline",
      timelineExpand: "Show details",
      timelineCollapse: "Hide details",
      duePrefix: "Due",
      shipmentPrefix: "Shipment",
      nextActionPendingDeposit: "Waiting for deposit payment.",
      nextActionRemainderDue: "Remainder payment {amount} is due {date}.",
      nextActionRemainderDueNoDate: "Remainder payment {amount} is due.",
      nextActionPreparing: "Your order is being prepared for shipment.",
      nextActionShipped: "Your order has been shipped.",
      nextActionDelivered: "Your order has been delivered.",
      ...
      remainderPayment: {
        ...
        additionsClosed: "Additions close at 23:59 the day before shipment.",
        discountToday: "30% off extra eggs today.",
        noEggsThisWeek: "No available eggs for this week.",
        eggsLeft: "eggs left",
        cartImportedNotice: "{count} eggs from your cart have been added as a draft to this order.",
        paymentChoiceTitle: "How do you want to pay for this change?",
        paymentChoiceDescription: "You can either pay the deposit on the new eggs now, or settle the full remaining balance right away.",
        depositOnNewEggsTitle: "Pay the deposit on the new eggs",
        depositOnNewEggsDescription: "You pay 50% of the new eggs now. The rest is added to the remaining balance on the order.",
        payEverythingNowTitle: "Pay the full remaining balance now",
        payEverythingNowDescription: "You pay for both the new eggs and everything still outstanding on the original order right away.",
        paymentSummaryTitle: "Payment summary",
        paymentSummaryDescription: "The summary updates when you add eggs or change the payment option.",
        currentOutstanding: "Currently outstanding on the order",
        additionDepositsPaid: "Addition deposits already paid",
        outstandingAfterThisPayment: "Still outstanding after this payment",
        saveChangesOnly: "Save changes",
      },
    ...
    waitlist: {
      title: 'Waitlist',
      description: 'Express interest in eggs that are not currently available. We will contact you when they become available.',
      modeLabel: 'How would you like to be notified?',
      modeOrderAddon: 'Add to existing order',
      modeSpecificWeek: 'Specific week',
      modeAsap: 'As soon as possible',
      modeOrderAddonHint: 'You will be notified when more eggs become available for your order.',
      modeSpecificWeekHint: 'You will be notified when eggs become available for the selected week.',
      modeAsapHint: 'You will be notified when eggs become available for the next available week.',
      orderSelectLabel: 'Select order',
      orderSelectPlaceholder: 'Select an order...',
      noEligibleOrders: 'No eligible orders found',
      weekSelectLabel: 'Select week',
      weekSelectPlaceholder: 'Select a week...',
      weekAutoSelected: 'Week automatically selected',
      breedSelectLabel: 'Select breed',
      breedSelectPlaceholder: 'Select a breed...',
      quantityLabel: 'Number of eggs',
      notesLabel: 'Notes (optional)',
      notesPlaceholder: 'Any special requests...',
      bestEffort: 'We do our best to accommodate waitlist requests, but cannot guarantee availability.',
      addButton: 'Add to waitlist',
      successTitle: 'Added to waitlist!',
      successDescription: 'We will contact you when eggs become available.',
      closeButton: 'Close',
  ...
  eggOps: {
    ...
    subtitle: "Daily registration and overview",
    loading: "Loading...",
    language: "Language",
    langNo: "Norsk",
    langEn: "English",
    ...
    saved: "Saved",
    clearDay: "Clear day",
    clearDayConfirm: "Are you sure you want to clear all numbers for this day?",
    clearRow: "Clear row",
    miscEggs: "Other eggs",
    editMisc: "Edit other",
    duckEggs: "Duck eggs",
    easyTapHint: "Tap a breed to register",
    otherEggsExtra: "Other eggs (extra)",
    miscNotInTotals: "Other eggs are not included in totals",
    easyPickBreed: "Pick breed",
    offlineQueued: "Saved offline – will sync soon",
    syncing: "Syncing...",
    syncNow: "Sync now",
    noBreed: "Unknown breed",
    rowStored: "Row saved",
    rowPending: "Pending",
    easyFinish: "Finish",
    close: "Close",
    ...
    kpiSellable: "Sellable",
    kpiRate: "Quality rate",
    kpiForecast: "Forecast",
    kpiLow: "Low",
    saveMisc: "Save other",
    dayClosedSaveHint: "Day is closed – reopen to make changes",
    pickBreed: "Pick breed",
    pickBreedHint: "Select a breed to start registration",
    ...
    heatmapHelp: "Colors show collection volume per breed per day",
    auditTitle: "Audit log",
    noAuditRows: "No changes recorded",
    auditFallbackBreed: "Unknown breed",
    auditFallbackUpdated: "Updated",
    auditFallbackUnknown: "Unknown",
    ...
    reload: "Could not load data – try reloading the page",
    mismatchTitle: "Mismatch detected",
    mismatchBody: "Numbers do not match – check the registration",
    failedDaily: "Could not load daily data",
  ...
  milkOps: {
    title: "Milk Log",
    subtitle: "Daily tracking and traceability",
    loading: "Loading...",
    date: "Date",
    today: "today",
    prevDay: "Previous day",
    ...
    bottles: "Bottles",
    bottleTare: "Bottle tare",
    customTare: "Custom tare",
    netMilk: "Net milk",
    grams: "grams",
    deciliters: "dL",
    machine: "Machine",
    ...
    avg30d: "Avg 30d",
    total: "Total",
    sumFromGoats: "Sum from goats",
    notes: "Notes",
    todaysNotes: "Today's notes",
    notesPlaceholder: "Unusual behavior, weather, illness...",
    noSessions: "No milking sessions yet.",
    startDay: "Start today's milking",
    addGoats: "Add goats for per-goat tracking",
    addGoat: "Add goat",
    goatName: "Name",
    goatTag: "Tag #",
    goatBreed: "Breed",
    goatNamePlaceholder: "E.g. Luna",
    goatBreedPlaceholder: "Norwegian dairy goat",
    cancel: "Cancel",
    save: "Save",
    ...
    healthNormal: "Normal",
    healthMastitis: "Mastitis suspect",
    healthColostrum: "Colostrum",
    healthBlood: "Blood traces",
    healthSmell: "Off smell",
    healthOther: "Other",
    production: {
      newBatch: "New production",
  ...
  oppdelingsplan: {
    ...
    ribbeTypeInfo: "All four variants use different parts of the rib side and belly",
    ...
    addingToOrderOrderLine: "Adding to order {orderNumber} - {box}",
  ...
  admin: {
    ...
    chickenBreeds: {
      ...
      errorFetchDescription: 'Could not load breeds',
      saveToastTitle: 'Saved',
      saveToastCreated: 'created',
      saveToastUpdated: 'updated',
      errorSaveTitle: 'Error',
      errorSaveDescription: 'Could not save',
      deactivateToastTitle: 'Deactivated',
      deactivateToastDescription: 'Breed has been deactivated',
      ...
      labelDescriptionNo: 'Description (NO)',
      labelDescriptionEn: 'Description (EN)',
      labelStartPrice: 'Start price (kr)',
      labelWeeklyIncrease: 'Weekly increase (kr)',
      labelAdultPrice: 'Adult price (kr)',
      labelRoosterPrice: 'Rooster price (kr)',
      labelMortalityEarly: 'Mortality early % (week 0-4)',
      labelMortalityLate: 'Mortality late % (week 4+)',
      labelDisplayOrder: 'Display order',
      checkboxSellRoosters: 'Sell roosters',
    ...
    chickenHatches: {
      loading: 'Loading hatches...',
      errorFetchTitle: 'Error',
      errorFetchDescription: 'Could not load data',
      errorMissingDate: 'Missing date',
      errorMissingDateDescription: 'Select date for eggs in incubator.',
      errorNoBreeds: 'No breeds entered',
      errorNoBreedsDescription: 'Enter egg count for at least one breed.',
      createToastTitle: 'Created',
      createToastDescription: 'New multi-breed hatch saved.',
      errorCreateTitle: 'Error',
      errorCreateDescription: 'Could not create hatch',
      updateToastTitle: 'Updated',
      ...
      labelEggSetDate: 'Eggs in date',
      labelBatchNote: 'Batch note',
      placeholderBatchNote: 'Optional note for entire batch',
      tableHeaderBreed: 'Breed',
      tableHeaderEggsIn: 'Eggs in',
      tableHeaderEstimatedHatch: 'Est. hatch (50%)',
      tableHeaderActualHatched: 'Actual hatched',
      placeholderEggCount: '0',
      placeholderActualOptional: 'Optional',
      summaryTotalEggsIn: 'Total eggs in: {total}',
      summaryEstimatedHatch: 'Estimated hatch: {total}',
      buttonCreateHatch: 'Create hatch',
      emptyState: 'No chicken hatches yet.',
      cardTitleLegacy: 'Legacy hatch',
      cardTitleBatch: 'Hatch {batchCode}',
      cardSubtitleEggDate: 'Eggs in {date}',
      cardSubtitleHatchDate: 'Hatch date {date}',
      badgeLegacy: 'Legacy',
      badgeHatched: 'Hatched',
      ...
      summaryEggsIn: 'Eggs in: {total}',
      summaryEstClekk: 'Est. hatch: {total}',
      summaryActualHatched: 'Actual hatched: {total}',
      summaryHatchRate: 'Hatch rate: {rate}%',
      tableHeaderRase: 'Breed',
      tableHeaderEggInn: 'Eggs in',
      tableHeaderEstKlekk: 'Est. hatch',
      tableHeaderFactualHatched: 'Actual hatched',
      tableHeaderAvailableHens: 'Avail. hens',
      tableHeaderAvailableRoosters: 'Avail. roosters',
      tableHeaderAgeNow: 'Age now',
      tableHeaderPriceNow: 'Price now',
      tableHeaderStatus: 'Status',
      tableHeaderActions: 'Actions',
      labelAgeWeeks: '{weeks} weeks',
      labelPrice: 'kr {price}',
      badgeActive: 'Active',
      badgeInactive: 'Inactive',
      buttonEdit: 'Edit',
    ...
    chickenOrders: {
      ...
      errorFetchTitle: 'Error',
      errorFetchDescription: 'Could not load orders',
      errorFetchDetailDescription: 'Could not load order details',
      updateToastTitle: 'Updated',
      updateToastDescription: 'Status changed to {status}',
      errorUpdateTitle: 'Error',
      errorUpdateDescription: 'Could not update status',
      errorCollectRemainderDescription: 'Could not register remainder payment',
      ...
      tableHeaderAge: 'Age',
      tableHeaderPricePerHen: 'Price/hen',
      tableHeaderTotal: 'Total',
      tableHeaderStatus: 'Status',
      tableHeaderAction: 'Action',
      actionDropdownDefault: 'Change...',
      unknownBreed: '-',
      notAvailable: 'Not available',
      detailTitle: 'Order details {order}',
      detailDescription: 'Full overview of the chicken order.',
      detailLoading: 'Loading order details...',
      detailUnavailable: 'Order details are not available.',
      detailCustomerTitle: 'Customer',
      detailOrderTitle: 'Order',
      detailFinancialTitle: 'Financials',
      detailDeliveryTitle: 'Delivery',
      detailNotesTitle: 'Notes',
      detailPaymentsTitle: 'Payments',
      detailAdditionsTitle: 'Additions',
      detailOrderLinesTitle: 'Order lines',
      detailNoPayments: 'No payments registered yet.',
      detailNoAdditions: 'No additions on this order.',
      ...
      labelBreed: 'Breed',
      labelHens: 'Hens',
      labelRoosters: 'Roosters',
      labelPickup: 'Pickup',
      labelPickupMonday: 'Pickup Monday',
      labelAgeWeeks: 'Age',
      ageWeeksLabel: '{weeks} weeks',
      summaryBirdsLabel: 'Total birds',
      summaryPaidLabel: 'Paid',
      summaryRemainingLabel: 'Remaining',
      summaryTotalLabel: 'Order total',
      labelSubtotal: 'Subtotal',
      labelDeliveryFee: 'Delivery fee',
      labelTotal: 'Total',
      labelDeposit: 'Deposit',
      labelRemainder: 'Remainder',
      labelRemainderDueDate: 'Remainder due date',
      labelRemainderCollected: 'Remainder collected',
      labelRemainderCollectedBy: 'Collected by',
      labelDeliveryMethod: 'Delivery method',
      labelShippingAddress: 'Address',
      labelShippingPostalCode: 'Postal code',
      labelShippingCity: 'City',
      labelShippingCountry: 'Country',
      labelCustomerNotes: 'Customer note',
      labelAdminNotes: 'Admin note',
      labelRemainderCollectionNote: 'Remainder note',
      labelPaymentType: 'Type',
      labelPaymentStatus: 'Payment status',
      labelPaymentAmount: 'Amount',
      labelPaymentWhen: 'Time',
      labelAdditionQuantity: 'Quantity',
      labelAdditionSubtotal: 'Addition subtotal',
      pickupWeekLabel: 'Week {week}/{year}',
      viewDetailsButton: 'Details',
      collectRemainderButton: 'Register remainder',
      enableRemainderButton: 'Enable remainder payment',
      remainderEnabled: 'Remainder enabled ✓',
      enableRemainderSuccess: 'Remainder payment enabled for customer.',
      promptRemainderAmount: 'Remainder amount in NOK',
      promptOptionalNote: 'Optional note',
      invalidAmountDescription: 'Please enter a valid amount.',
      remainderRegisteredTitle: 'Remainder registered',
      remainderRegisteredDescription: 'Registered payment of {amount}.',
      errorEnableRemainderDescription: 'Could not enable remainder payment.',
      resendButton: 'Resend confirmation',
      resendSending: 'Sending...',
      resendSuccessTitle: 'Confirmation resent',
      resendSuccessDescription: 'The confirmation email was queued.',
      resendFailedDescription: 'Could not resend confirmation.',
    },

    // Recipe management
    recipes: {
      loading: 'Loading recipes...',
      errorLoadTitle: 'Could not load recipes',
      updateToastTitle: 'Recipe updated',
      createToastTitle: 'Recipe created',
      errorSaveTitle: 'Save failed',
      errorCreateTitle: 'Create failed',
      deleteConfirm: 'Are you sure you want to delete this recipe?',
      deleteToastTitle: 'Recipe deleted',
      errorDeleteTitle: 'Delete failed',
      title: 'Recipes',
      buttonNewRecipe: 'New recipe',
      emptyState: 'No recipes yet. Click "New recipe" to create one.',
      difficultyEasy: 'Easy',
      ...
      labelServings: '{servings} servings',
      labelOrder: '#{order}',
      buttonEdit: 'Edit',
      buttonDelete: 'Delete',
      modalTitleNew: 'New recipe',
      modalTitleEdit: 'Edit: {title}',
      labelTitleNo: 'Title (NO)',
      labelTitleEn: 'Title (EN)',
      labelSlug: 'Slug',
      placeholderSlug: 'e.g. carbonara-guanciale',
      labelIntroNo: 'Intro (NO)',
      labelIntroEn: 'Intro (EN)',
      placeholderIntroNo: 'Short recipe introduction',
      placeholderIntroEn: 'Short recipe introduction',
      sectionIngredientsNo: 'Ingredients (NO)',
      ...
      buttonRemove: 'Remove',
      buttonAddIngredient: 'Add ingredient',
      buttonAddIngredientEn: 'Add ingredient',
      sectionStepsNo: 'Steps (NO)',
      sectionStepsEn: 'Steps (EN)',
      placeholderStep: 'Step {number}',
      placeholderStepEn: 'Step {number}',
      buttonRemoveStep: 'Remove step',
      buttonRemoveStepEn: 'Remove step',
      buttonAddStep: 'Add step',
      buttonAddStepEn: 'Add step',
      labelTipsNo: 'Tips (NO)',
      labelTipsEn: 'Tips (EN)',
      placeholderTipsNo: 'General tips',
      placeholderTipsEn: 'General tips',
      labelMangalitsaTipNo: 'Mangalitsa tip (NO)',
      labelMangalitsaTipEn: 'Mangalitsa tip (EN)',
      placeholderMangalitsaTipNo: 'Mangalitsa-specific tip',
      placeholderMangalitsaTipEn: 'Mangalitsa-specific tip',
      labelDifficulty: 'Difficulty',
      labelPrepTime: 'Prep time (min)',
      labelCookTime: 'Cook time (min)',
      labelServingsInput: 'Servings',
      labelImageUrl: 'Image URL',
      placeholderImageUrl: 'https://...',
      imagePreview: 'Preview',
      labelRelatedExtras: 'Related extras (slugs, comma-separated)',
      placeholderRelatedExtras: 'e.g. guanciale, pancetta, lardo',
      checkboxActive: 'Active (visible to customers)',
      labelDisplayOrder: 'Display order',
      buttonSave: 'Save',
      buttonSaving: 'Saving...',
      buttonCreate: 'Create',
      buttonCancel: 'Cancel',
      placeholderTitleNo: 'Recipe title in Norwegian',
    ...
    seasonSettings: {
      ...
      subtitle: 'Configure important dates and deadlines for the season',
      sectionCutoffTitle: 'Change deadline',
      cutoffInfoTitle: 'This is the deadline for when customers can change orders',
      cutoffInfoDescription: 'After week {week}, {year} orders will be locked',
      labelYear: 'Year',
      labelWeekNumber: 'Week number',
      sectionDeliveryWindow: 'Delivery window',
      labelStartWeek: 'Start week',
      labelEndWeek: 'End week',
      deliveryWindowPreview: 'Customers will see: "Estimated delivery: Week {startWeek}-{endWeek}, {year}"',
      sectionOrderPeriod: 'Order period (optional)',
      labelStartDate: 'Start date',
      labelEndDate: 'End date',
      toggleAcceptOrders: 'Accept new orders',
      toggleAcceptOrdersDescription: 'Turn off to stop accepting new orders',
    },

    // Mangalitsa cuts manager
    mangalitsaCuts: {
      loading: 'Loading cuts...',
      errorLoadTitle: 'Could not load cuts/parts',
      updateToastTitle: 'Cut updated',
      errorUpdateTitle: 'Save failed',
      title: 'Cuts (catalog)',
      countLabel: '{count} cuts',
      badgeInactive: 'Inactive',
      labelSlug: 'Slug:',
      labelPartOf: 'From part of pig:',
      labelUnknownPart: 'Unknown part',
      labelWeightRange: 'Weight range:',
      buttonEdit: 'Edit',
      modalLabelNameNo: 'Name (NO)',
      modalLabelNameEn: 'Name (EN)',
      modalLabelChefNo: 'Chef name (NO)',
      modalLabelChefEn: 'Chef name (EN)',
      modalPlaceholderChefNo: 'e.g. coppa',
      modalPlaceholderChefEn: 'e.g. coppa',
      modalLabelPart: 'Part of pig',
      modalSelectPartDefault: 'Select part',
      modalLabelDisplayOrder: 'Display order',
      modalCheckboxActive: 'Active',
      modalLabelFromKg: 'From weight (kg)',
      modalLabelToKg: 'To weight (kg)',
      modalPlaceholderFromKg: 'e.g. 0.8',
      modalPlaceholderToKg: 'e.g. 1.1',
      modalLabelDescriptionNo: 'Description (NO)',
      modalLabelDescriptionEn: 'Description (EN)',
      modalAlertWeightBoth: 'You must fill in both from-weight and to-weight, or leave both empty.',
      modalAlertWeightOrder: 'To-weight must be greater than or equal to from-weight.',
    ...
    eggInventory: {
      ...
      labelActiveWeeks: 'Active weeks',
      labelAvailable: 'Available',
      labelRemaining: 'Remaining',
      labelSoldOut: 'Sold out',
      warningLowStock: 'Low stock: ',
      warningEggsLabel: 'eggs',
      bulkSelectedWeeks: '{count} weeks selected',
      bulkCloseAll: 'Close all',
      bulkOpenAll: 'Open all',
      labelEggsPerBreed: 'Eggs per breed',
      tableHeaderWeek: 'Week',
      tableHeaderDelivery: 'Delivery',
      tableHeaderTotal: 'Total',
      tableHeaderRemainingTotal: 'Total remaining',
      monthWeeksLabel: '{count} weeks',
      monthEggsLeft: '{count} eggs left',
      weekLabel: 'Week',
      editPanelCapacity: 'Capacity:',
      editPanelAllocated: 'Allocated: {count}',
      editPanelRemaining: 'Remaining: {count}',
      legendAvailable: 'Available',
      legendAlmostFull: 'Almost full (80%+)',
      legendSoldOut: 'Sold out',
      legendClosed: 'Closed',
      legendHelp: 'Click a cell to edit capacity and status',
      weekAbbrev: 'Wk',
      buttonCancel: 'Cancel',
      buttonSave: 'Save',
      buttonSaving: 'Saving...',
    ...
    communicationCenter: {
      flowTemplatesTitle: 'Order flow templates (eggs + Mangalitsa)',
      flowTemplatesSubtitle: 'Used for order confirmation, season update, slaughter/packing week, delivery and feedback.',
      flowUseInComposer: 'Use in composer',
      flowLabelActive: 'Active',
      flowLabelInactive: 'Inactive',
      flowLabelNameNo: 'Name (NO)',
      flowLabelNameEn: 'Name (EN)',
      flowLabelSubjectNo: 'Subject (NO)',
      flowLabelSubjectEn: 'Subject (EN)',
      flowLabelMessageNo: 'Message (NO)',
      flowLabelMessageEn: 'Message (EN)',
      flowCheckboxActive: 'Active template',
      flowButtonSave: 'Save flow template',
      flowButtonSaving: 'Saving...',
      flowSavedTitle: 'Template saved',
      flowSavedDescription: 'The flow template was updated.',
    },

    // Configuration management
    configuration: {
      depositInfo: 'Deposit is fixed at 50% of the selected Mangalitsa box price.',
    },
  },
  ...
  footer: {
    ...
    organic: "Woolly Pig, raised outdoors on pasture and fed quality feed",
    links: "Links",
  ...
  norwayMap: {
    ...
    address: "7750 Namdalseid, Trondelag",
  },
  ...
  customerMessagingPanel: {
    ...
    sending: "Sending...",
    sendMessage: "Send message",
    attachOrderLabel: "Attach to order",
    attachOrderOptional: "Optional",
    attachOrderHelp: "Pick an existing order if your message is about a booking we already have on file.",
    attachOrderPlaceholder: "Choose an order from the list",
    attachOrderNone: "No attached order",
    attachOrderEmpty: "You do not have any orders to choose from yet.",
    attachedOrderTitle: "Attached order",
    orderPreviewTitle: "Order preview",
    orderPreviewHint: "Hover an order to preview its contents here.",
    orderPreviewStatus: "Status",
    orderPreviewTotal: "Total",
    orderPreviewDelivery: "Delivery",
    orderPreviewCreated: "Created",
    orderPreviewContents: "Contents",
    orderPreviewNotes: "Note",
    orderTypePig: "Mangalitsa",
    orderTypeEgg: "Hatching eggs",
    orderTypeChicken: "Chickens",
    deliveryPosten: "Ships with Posten",
    deliveryFarmPickup: "Pickup at the farm",
    deliveryE6Pickup: "Pickup at E6",
    deliveryTrondheimPickup: "Pickup in Trondheim",
    ...
    statusClosed: "Closed",
    communicationsTitle: "System communication",
    communicationsSubtitle: "Automatic emails and updates from the system.",
    communicationsLoading: "Loading communication...",
    communicationsEmpty: "No emails registered yet",
    communicationsLoadError: "Could not load communication history",
    communicationsSentAt: "Sent",
    communicationsCreatedAt: "Created",
    communicationsClassification: "Type",
    communicationsTemplate: "Template",
    communicationsNoSubject: "(No subject)",
    communicationStatusSent: "Sent",
    communicationStatusPending: "Pending",
    communicationStatusProcessing: "Processing",
    communicationStatusFailed: "Failed",
    communicationStatusDead: "Stopped",
    communicationStatusCancelled: "Cancelled",
    communicationStatusUnknown: "Unknown",
    communicationClassificationTransactional: "Transactional",
    communicationClassificationSupport: "Support",
    communicationClassificationPromotional: "Campaign",
    communicationClassificationSystem: "System",
    communicationClassificationUnknown: "Unknown",
  },
  ...
  orderDetailsCard: {
    ...
    timelineExpand: "Show details",
    timelineCollapse: "Hide details",
    timelineRemainderPaid: "Remainder paid",
    timelinePickupPrefix: "Ready for pickup",
    total: "Total",
  ...
  inventoryManagement: {
    ...
    boxManagementTitle: "Box management (Mangalitsa)",
    labelOrders: "orders",
    labelRemaining: "remaining",
    placeholderNoLimit: "No limit",
    labelActive: "Active",
    labelInactive: "Inactive",
    emptyPresets: "No boxes found",
    extrasTitle: "Extra products (inventory)",
    placeholderUnlimited: "Unlimited",
    emptyExtras: "No extra products found",
    eggOverviewTitle: "Hatching eggs inventory overview",
    eggWeeksOnSale: "Weeks on sale",
    eggAvailable: "Available",
    eggRemaining: "Remaining",
  },
  ...
  customerDatabase: {
    ...
    orderSaveSuccessDescription: "Order changes have been saved.",
    fieldLabels: {
      quantity: "Quantity",
      hens: "Hens",
      roosters: "Roosters",
      ...
      pickupYear: "Pickup year",
      pickupWeek: "Pickup week",
      pricePerHen: "Price/hen",
      pricePerRooster: "Price/rooster",
    ...
    orderDetailsLoading: "Loading order...",
    ...
    paymentsInfoTitle: "Payments",
    noPayments: "No payments",
    additionsInfoTitle: "Additions",
    ...
    orderDetailsButton: "Show details",
    orderDetailsHideButton: "Hide details",
    communicationTitle: "Communication",
    communicationSubtitle: "Send messages to the customer from this view.",
    communicationNoSubject: "(no subject)",
    communicationTypeLabel: "Type",
    communicationTemplateLabel: "Template",
    communicationSentAtLabel: "Sent",
    communicationCreatedAtLabel: "Created",
    noCommunications: "No communications",
    sendMessageButton: "Send message",
    supportThreadsTitle: "Customer messages",
    supportThreadsSubtitle: "Start new support threads and review recent conversation history.",
    supportMessageDeliveryEmail: "New threads notify the customer by email and appear in My page.",
    supportMessageDeliveryPortalOnly: "This customer has no email address on file. Messages will be available in My page.",
    supportMessageNoContact: "No contact details are available for this customer yet.",
    supportThreadStartedByLabel: "Started by",
    supportThreadUpdatedLabel: "Updated",
    supportThreadOrderLabel: "Order",
    supportThreadLastCustomerReply: "Latest customer reply",
    supportThreadLastFarmReply: "Latest farm reply",
    supportThreadOpenButton: "Open in inbox",
    noSupportThreads: "No support threads for this customer yet.",
    messageComposerTitle: "Send customer message",
    messageComposerDescription: "Start a new support thread from this customer profile.",
    messageComposerOrderLabel: "Related order (optional)",
    messageComposerOrderPlaceholder: "General message",
    messageComposerTypeLabel: "Category",
    messageComposerPriorityLabel: "Priority",
    messageComposerSubjectLabel: "Subject",
    messageComposerSubjectPlaceholder: "What is this about?",
    messageComposerBodyLabel: "Message",
    messageComposerBodyPlaceholder: "Write the message the customer should receive.",
    messageComposerCancelButton: "Cancel",
    messageComposerSendingButton: "Sending...",
    messageComposerSendButton: "Send message",
    messageSendMissingTitle: "Missing information",
    messageSendMissingDescription: "Subject and message are required before you can send.",
    messageSendNoContactTitle: "No contact details",
    messageSendNoContactDescription: "This customer needs an email address or phone number before messaging can start.",
    messageSendSuccessTitle: "Message sent",
    messageSendSuccessDescription: "The customer was notified by email and can reply from My page.",
    messageSendPortalOnlyDescription: "The thread was created. The customer can read it next time they open My page.",
    messageSendErrorTitle: "Send failed",
    messageSendErrorDescription: "Could not send the message.",
  ...
  eggInventoryManagement: {
    ...
    closeButton: "Close",
    openButton: "Open",
    confirmCloseTitle: "Confirm closing",
    confirmCloseDescription: "Are you sure you want to close all selected weeks? Existing orders are not affected, but new orders will not be possible.",
    confirmCloseButton: "Close weeks",
    reopenButton: "Reopen",
  },
  eggOrdersWorkbench: {
    locale: "en-US",
    ...
    sortOptions: {
      ...
      payment_asc: "Payment ascending",
      payment_desc: "Payment descending",
    ...
    markSent: {
      button: "Mark sent",
      modalTitle: "Mark orders sent",
      modalDescription: "Add a tracking number or tracking link from Posten.",
      trackingLabel: "Tracking number or link",
      trackingPlaceholder: "70722152462051361 or https://sporing.posten.no/...",
      formatHint: "Paste a tracking number (e.g. 70722152462051361) or full tracking link from Posten",
      cancelButton: "Cancel",
      confirmButton: "Confirm",
      successToast: "Order marked as sent",
      invalidFormat: "Invalid tracking format",
    },
    payments: {
      title: "Payment history",
    ...
    unifiedState: {
      ...
      remainderDue: "Remainder unpaid",
      remainderOverdue: "Remainder overdue",
      remainderDueDays: "Remainder - {days}d",
      fullyPaid: "Ready to ship",
      preparing: "Preparing",
      shipped: "Shipped",
      delivered: "Delivered",
      cancelled: "Cancelled",
    ...
    weekChecklist: {
      title: "Week checklist — Week {week}/{year}",
      totalOrders: "{count} orders total",
      missingShipping: "{count} missing shipping address",
      outstandingRemainder: "{count} with unpaid remainder",
      overdueRemainder: "{count} with overdue remainder",
      allGood: "All clear for shipment!",
      noOrdersThisWeek: "No orders for selected week.",
    },
    monitor: {
      title: "Remainder payment monitor",
      subtitle: "Orders with remainder due within 14 days, sorted by due date",
      ...
      reminderSent: "Sent!",
      empty: "No active orders with unpaid remainder within 14 days.",
      columnCustomer: "Customer",
      columnOrder: "Order",
      columnBreed: "Breed / week",
      columnAmount: "Amount due",
      columnDue: "Due date",
      columnDays: "Days left",
      columnAction: "Action",
    },
    pipeline: {
      title: "Week pipeline",
      noWeekSelected: "Select a week in the filter to see pipeline view.",
      columns: {
        pending: "Awaiting deposit",
        deposit_paid: "Deposit paid",
        fully_paid: "Fully paid",
    ...
    confirm: {
      ...
      cancelDescription: "Are you sure you want to cancel this order? Inventory will be released.",
      cancelAndRefundTitle: "Confirm cancellation and refund",
      cancelAndRefundDescription: "Are you sure? The order will be cancelled, inventory released, and deposit refunded via Vipps.",
      refundDepositTitle: "Confirm deposit refund",
      refundDepositDescription: "Are you sure you want to refund the deposit via Vipps? This cannot be undone.",
      confirmButton: "Confirm",
      cancelButton: "Cancel",
    },
  },
  ...
  adminPage: {
    ...
    eggWeekTracker: {
      title: "Egg week overview",
      orderedNextMonday: "Ordered next Monday",
      collectedSoFar: "Collected so far",
      forecastFullWeek: "Forecast (full week)",
      statusNow: "Missing now",
      predictionSunday: "Prediction Sunday evening",
      surplus: "surplus",
      deficit: "missing",
      balanced: "balanced",
      breed: "Breed",
      ...
      nextWeek: "Next week",
      currentWeek: "Back to default view",
      noData: "No egg data for the selected week",
  ...
  recipes: {
    ...
    mainSectionTitle: 'Meals and weekend cooking',
    mainSectionSubtitle: 'Ready-to-cook recipes with Mangalitsa pork.',
    diySectionTitle: 'Make it yourself',
    diySectionSubtitle: 'Curing, aging, and home projects you do yourself.',
    ...
    chooseOrderTitle: 'Choose which order to update',
    chooseOrderDescription: 'We found multiple orders. Choose the one that should receive this extra cut.',
    unknownOrderBox: 'Unknown box',
    addToOrderSuccessTitle: 'Added to order',
    addToOrderSuccessBody: '{piece} was added as an extra.',
    addToOrderErrorTitle: 'Could not update order',
    addToOrderErrorBody: 'Please try again, or open My page to add extras manually.',
    noOrdersFoundTitle: 'No order found',
    noOrdersFoundBody: 'We could not find an active order. We will open a new checkout with the right box and cut selected.',
  },
  ...
  chickens: {
    ...
    orderForm: {
      ...
      sexDisclaimer: 'Note: Before week 10, chickens are sold without sex guarantee. From week 10 you can choose roosters, and we guarantee hens if you do not.',
      unhatchedWishlistDisclaimer: 'Note: Some of these chickens have not hatched yet. The final number of chicks, the hen/rooster split, and survival are therefore uncertain, so this order works more like a wishlist for now. If anything happens, you will of course receive a full refund.',
      futureLiveBirdDisclaimer: 'Note: These are live birds, and when you order more than two weeks ahead things can still happen along the way. We therefore cannot guarantee the order exactly as requested, but a full refund will be given if we cannot fulfil it.',
      creamLegbarDisclaimer: 'Cream Legbar chicks are sex-linked from hatch, so these are guaranteed female from day one.',
    },
    orderSummary: {
      title: 'Order Summary',
      pickupWeek: 'Pickup week',
    ...
    myOrders: {
      ...
      nextActionRemainderDue: 'Remainder payment {amount} is due {date}.',
      nextActionRemainderDueNoDate: 'Remainder payment {amount} is due.',
      nextActionFullyPaid: 'Full payment received. We will notify you when pickup is ready.',
      nextActionReadyForPickup: 'The chickens are ready for pickup.',
      nextActionPickedUp: 'The order has been picked up.',
      nextActionProcessing: 'Your order is being processed.',
      remainderPaidPrefix: 'Remainder paid',
      daysLeftLabel: 'days left',
      stepReserved: 'Ordered',
      stepDeposit: 'Deposit',
      stepRemainder: 'Remainder',
      stepPickup: 'Pickup',
      statusPending: 'Pending',
