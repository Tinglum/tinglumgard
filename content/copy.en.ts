export const en = {
  ...
  breed: {
    ...
    humidity: "Humidity",
    qualityNote: "Our hens are not perfect. They have been selectively bred for years to become as good as possible, but perfection is not realistic. We prioritize egg size, egg colors, and hens that stay close to breed standards.",
  ...
  timeline: {
    ...
    step1Desc: "Pay advance payment (50%) with Vipps. Your box is secured when the deposit payment is completed.",
    step1Time: "Week 44",
    ...
    step3Desc: "The pigs are professionally slaughtered and packed fresh. Then everything is frozen for optimal shelf life and picked up/delivered in week 48.",
    step3Time: "Week 48",
    step4Title: "Fresh delivery (optional)",
    step4Desc: "For a small extra fee you can choose fresh pickup in week 50-51. Perfect if you want the meat completely fresh for Christmas!",
  ...
  faq: {
    ...
    a1: "Each box has a fixed composition of cuts tailored to the box theme. Everything is portioned, labeled and vacuum packed. Fixed structure, small variations should be expected.",
  ...
  eggs: {
    ...
    breedsPage: {
      subtitle:
        "Four unique breeds with distinct traits and egg colors. The focus is quality of hens and chicks, not table eggs.",
    ...
    breedDetails: {
      'ayam-cemani': {
        description: 'Rare Indonesian breed with a fully black appearance. Eggs are cream to light brown (not black).',
        detailedDescription:
          'Ayam Cemani is valued for its striking all-black expression and is a breed many enthusiasts wait for. Egg color is cream to light brown, not black. We selectively breed for stable type, good egg size, and strong chicks close to breed standard. The breed can be more demanding to incubate than others, so stable temperature and humidity are especially important.',
        eggColor: 'Cream to light brown (not black)',
        sizeRange: '2-2.5 kg',
      ...
      'jersey-giant': {
        description: 'Large and calm breed that lays large brown eggs.',
        detailedDescription:
          'Jersey Giant is a robust breed with a calm temperament and strong egg size. We prioritize breeding birds that deliver reliable egg size, stable quality, and hens close to breed standard. The goal is strong, functional chicks with consistent type over time.',
        eggColor: 'Brown',
        sizeRange: '4-5 kg',
      ...
      'silverudds-bla': {
        description: 'Swedish breed known for green to olive-green eggs.',
        detailedDescription:
          "Silverudd's Blue is an active and hardy breed with characteristic green egg tones. We breed for clear egg color, good egg size, and hens close to standard. Egg color genetics are complex, so shade and intensity can vary somewhat between birds and seasons.",
        eggColor: 'Green to olive',
        sizeRange: '2.5-3 kg',
      ...
      'cream-legbar': {
        description: 'Autosexing breed with light blue eggs and clear sexing at hatch.',
        detailedDescription:
          'Cream Legbar is popular because chicks can often be sexed early (autosexing), while the breed lays light blue eggs. In our breeding work we prioritize clear sex-link traits, even egg color, and solid egg size. The breed is sought after by hobby breeders who want as much predictability as possible.',
        eggColor: 'Light blue / turquoise',
        sizeRange: '2-2.5 kg',
      ...
      maran: {
        description: 'French breed known for dark brown eggs and classic copper-neck expression.',
        detailedDescription:
          'Copper Maran is valued for deep brown egg tones and elegant breed type. We breed for stable egg color, good egg size, and hens close to breed standard. Darkness in egg color can vary between seasons and individual birds.',
        eggColor: 'Dark brown to reddish',
        sizeRange: '2.5-3 kg',
  ...
  admin: {
    ...
    chickenOrders: {
      ...
      ageWeeksLabel: '{weeks} w',
      collectRemainderButton: 'Collect balance',
      viewDetailsButton: 'Details',
      promptRemainderAmount: 'Registered amount (NOK)',
      promptOptionalNote: 'Note (optional)',
      invalidAmountDescription: 'Invalid amount',
      remainderRegisteredTitle: 'Balance registered',
      remainderRegisteredDescription: '{amount} was registered',
      errorCollectRemainderDescription: 'Could not register balance',
      errorFetchDetailDescription: 'Could not fetch order details',
      detailTitle: 'Order details {order}',
      detailDescription: 'Complete overview of this chicken order.',
      detailLoading: 'Loading order details...',
      detailUnavailable: 'No order details available.',
      detailCustomerTitle: 'Customer',
      detailOrderTitle: 'Order',
      detailFinancialTitle: 'Amounts',
      detailDeliveryTitle: 'Delivery',
      detailNotesTitle: 'Notes',
      detailPaymentsTitle: 'Payments',
      detailAdditionsTitle: 'Additions',
      detailNoPayments: 'No payments registered.',
      detailNoAdditions: 'No additions registered.',
      ...
      labelAdditionQuantity: 'Addition quantity',
    ...
    eggInventory: {
      ...
      weekLabel: 'Week',
      editPanelForecastBase: 'Automation:',
      editPanelAdjustment: 'Adjustment (+/-):',
      ...
      legendClosed: 'Closed',
      legendAdjusted: 'Cells with + or - have manual adjustment',
      legendHelp: 'Click a cell to edit adjustment and status',
      weekAbbrev: 'Wk',
      buttonCancel: 'Cancel',
      buttonSave: 'Save',
      buttonSaving: 'Saving...',
  ...
  customerMessagingPanel: {
    ...
    communicationStatusDead: "Dead letter",
    ...
    communicationClassificationPromotional: "Promotional",
  ...
  customerDatabase: {
    ...
    orderSaveSuccessTitle: "Saved",
    orderSaveSuccessDescription: "Order was updated",
    orderSaveErrorTitle: "Could not save order",
    orderSaveErrorDescription: "Please try again.",
    communicationTitle: "Communication",
    communicationSubtitle: "System emails sent to this customer",
    noCommunications: "No emails registered",
    ...
    fieldLabels: {
      ...
      quantity: "Quantity",
      pricePerEgg: "Price per egg (ore)",
      deliveryMethod: "Delivery method",
      deliveryFee: "Delivery fee (ore)",
      hens: "Hens",
      roosters: "Roosters",
      pickupYear: "Pickup year",
      pickupWeek: "Pickup week",
      pricePerHen: "Price per hen (NOK)",
      pricePerRooster: "Price per rooster (NOK)",
    ...
    deliveryMethodLabels: {
      ...
      e6_pickup: "E6 pickup point",
      farm_pickup: "Farm pickup",
      pickup_farm: "Farm pickup",
      pickup_e6: "E6 pickup",
      delivery_trondheim: "Delivery in Trondheim",
      delivery_namsos_trondheim: "Delivery Namsos/Trondheim",
    },
    ...
    profileSubtitle: "Unified customer profile across all products.",
    orderHistoryHint: "Quick actions: details, resend confirmation, edit.",
    noOrdersForCustomer: "No orders registered for this customer.",
    resendConfirmationButton: "Resend confirmation",
    resendConfirmationLoading: "Sending...",
    resendConfirmationSuccessTitle: "Confirmation resent",
    resendConfirmationSuccessDescription: "The confirmation email was queued successfully.",
    resendConfirmationErrorTitle: "Could not resend confirmation",
    resendConfirmationMissingDescription: "No previous email was found for this order yet.",
  ...
  eggOrdersWorkbench: {
    ...
    markSent: {
      button: "Mark as sent",
      modalTitle: "Add tracking number",
      modalDescription: "Enter the Posten tracking number. The customer will receive an email with tracking link.",
      trackingLabel: "Posten tracking number",
      trackingPlaceholder: "370722152364073509",
      formatHint: "18-digit Posten tracking number",
      cancelButton: "Cancel",
      confirmButton: "Mark as sent",
      successToast: "Order marked as shipped and customer notified",
      invalidFormat: "Tracking number must be exactly 18 digits",
    },
  },
  ...
  mangalitsa: {
    ...
    hero: {
      ...
      subtitle: 'This is not regular pork. This is woolly pig, bred for extreme flavor, fat content and juiciness.',
    ...
    boxes: {
      ...
      familieboks: {
        name: 'Family Box',
        tagline: 'Great dinners for the whole family',
  ...
  chickens: {
    ...
    page: {
      ...
      bookingAgeNote: 'You can order from newly hatched chicks. The price for 0-4 weeks is the same.',
    ...
    myOrders: {
      ...
      addMoreTitle: 'Add more chickens',
      addMoreDescription: 'Pickup week {week}, {year}. Add more lines below.',
      additionRowMeta: '{age} weeks - {price} each - {available} available',
      additionsSummary: '{count} selected - {total}',
      clearAdditionsDraft: 'Reset',
      additionsSave: 'Save additions',
      additionsSaving: 'Saving...',
      additionsSavedTitle: 'Updated',
      additionsSaved: 'Order updated successfully.',
      additionsLoadFailedTitle: 'Could not load availability',
      additionsLoadFailed: 'Please try again in a moment.',
      additionsSaveFailedTitle: 'Could not save additions',
      additionsSaveFailed: 'Please try again.',
      noAdditionsSelectedTitle: 'No selection',
      noAdditionsSelected: 'Select at least one line before saving.',
      noAdditionsAvailable: 'No more chickens are available for this pickup week.',
    },
    admin: {
      tabLabel: 'Chickens',
      subTabs: {
  ...
  eggOps: {
    ...
    dayClosed: 'Closed',
    dayClosedSaveHint: 'Day is closed. Reopen day before saving.',
    ...
    noAuditRows: 'No audit rows.',
    auditFallbackBreed: 'Breed',
