...
export function QuestExperience() {
  ...
  const goToQuestion = (index: number) => { cancelAutoAdvance(); setWaitingAtSection(null); setSectionIntro(null); setMessage(''); setQuestionIndex(index) }
  const navInner = (
