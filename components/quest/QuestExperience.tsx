...
export function QuestExperience() {
  ...
  async function choose(questionId: string, answerKey: string) {
    ...
    else if(!offlineMode&&released<5)setTimeout(()=>{if(document.activeElement instanceof HTMLElement)document.activeElement.blur();setWaitingAtSection(released)},160)
