...
type ParticipantRow = { id: string; display_name: string; email?: string | null; answers: Record<string,string>; answered_count: number; current_question: number; earned_points: number; section_scores: number[]; last_seen_at: string; submitted_at?: string; feedback?: { message:string; updated_at:string; sent_at?:string } | null; fasting_challenge?: { opted_in:boolean; track?:'standard'|'advanced'|'very_advanced'; status:'enrolled'|'withdrawn'|'completed'; updated_at:string } | null }
