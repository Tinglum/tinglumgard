...
import { ExternalLink, ChefHat, Flame } from 'lucide-react';
...
export function ExtraProductModal({ extra, position, onClose }: ExtraProductModalProps) {
  ...
  const name = lang === 'no' ? extra.name_no : extra.name_en;
  ...
  return (
    ...
    >
      <div className="mb-4">
        <h3 className="text-xl font-normal text-neutral-900 mb-1">{name}</h3>
        {chefTerm && (
