...
FROM (
  VALUES
    ...
    ('svine-entrecote', 'Svine-entrecote', 'Pork ribeye', 'ribeye', 'ribeye', 'kotelettkam', 60),
    ...
    ('kokkefett-smult', 'Kokkefett', 'Cooking fat', 'smult/lard', 'lard', 'ribbeside', 110),
    ('bogstek', 'Bogstek', 'Shoulder roast', 'shoulder', 'shoulder', 'svinebog', 120),
    ('kjottdeig-grov', 'Kjottdeig, grov og saftig', 'Ground pork, coarse & juicy', 'mince', 'mince', 'svinebog', 130),
    ('gryte-stekekjott', 'Gryte/stekekjott', 'Stew/roast meat', 'stew cut', 'stew cut', 'svinebog', 140),
    ('premium-polse', 'Premium polse', 'Premium sausage', 'sausage', 'sausage', 'svinebog', 150),
    ('bbq-polse', 'BBQ-polse', 'BBQ sausage', 'sausage', 'sausage', 'svinebog', 160),
    ('medisterpolser', 'Medisterpolser av Mangalitsa', 'Mangalitsa medister sausages', 'medister sausage', 'medister sausage', 'svinebog', 170),
    ('medisterfarse', 'Medisterfarse', 'Medister mince', 'medister mince', 'medister mince', 'svinebog', 180),
    ('julepolse', 'Julepolse', 'Christmas sausage', 'julepolse', 'christmas sausage', 'svinebog', 190),
