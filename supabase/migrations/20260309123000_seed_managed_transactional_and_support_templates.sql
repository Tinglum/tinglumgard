...
VALUES
  (
    ...
    '<h2>Bestilling bekreftet</h2><p>Hei {{customer_name}},</p><p>Vi har mottatt forskuddet for <strong>{{order_number}}</strong>.</p><p><strong>Boks:</strong> {{box_label}}<br/><strong>Ribbe:</strong> {{ribbe_choice}}<br/><strong>Levering:</strong> {{delivery_label}}</p>{{extras_html}}{{discount_html}}<p><strong>Total:</strong> {{total_amount_nok}}<br/><strong>Forskudd betalt:</strong> {{deposit_amount_nok}}<br/><strong>Restbetaling:</strong> {{remainder_amount_nok}}</p><p>Neste steg og oppdateringer finner du på Min side.</p><p><a href="{{order_url}}" style="display:inline-block;background:#111827;color:#ffffff;text-decoration:none;padding:10px 16px;border-radius:8px;">Gå til Min side</a></p>',
  ...
  (
    ...
    '<h2>Bestillingen er klar</h2><p>Hei {{customer_name}},</p><p>Ordre <strong>{{order_number}}</strong> er nå klar for henting.</p><p><strong>Levering:</strong> {{delivery_label}}</p><p><a href="{{order_url}}" style="display:inline-block;background:#111827;color:#ffffff;text-decoration:none;padding:10px 16px;border-radius:8px;">Se detaljer på Min side</a></p>',
  ...
  (
    ...
    '<h2>Ordre last</h2><p>Hei {{customer_name}},</p><p>Ordre <strong>{{order_number}}</strong> er nå last og ferdigstilt.</p><p>Ingen flere endringer kan gjøres.</p><p><a href="{{order_url}}">Se ordren på Min side</a></p>',
  ...
  (
    ...
    '<h2>Refundering registrert</h2><p>Hei {{customer_name}},</p><p>Vi har registrert refundering for <strong>{{order_number}}</strong>.</p><p><strong>Beløp:</strong> {{refund_amount_nok}}<br/><strong>Type:</strong> {{refund_type_label}}</p><p>Behandlingstid er normalt 5-7 virkedager.</p><p><a href="{{order_url}}">Se bestilling</a></p>',
  ...
  (
    ...
    '<h2>Melding mottatt</h2><p>Hei {{customer_name}},</p><p>Vi har mottatt meldingen din.</p><p><strong>Referanse:</strong> {{thread_id}}</p><p><strong>Emne:</strong> {{subject_line}}</p><p>{{order_number}}</p><blockquote style="margin:16px 0;padding:12px 14px;background:#f4f4f5;border-left:4px solid #d4d4d8;white-space:pre-wrap;">{{message_text}}</blockquote><p>Du kan svare direkte på denne e-posten, eller gå til <a href="{{portal_url}}">{{portal_label}}</a>.</p>',
  ...
  (
    ...
    '<h2>Ny kundemelding</h2><p><strong>Fra:</strong> {{customer_name}} ({{customer_phone}})<br/><strong>E-post:</strong> {{customer_email}}</p><p>{{order_number}}</p><p><strong>Type:</strong> {{message_type}}<br/><strong>Emne:</strong> {{subject_line}}</p><blockquote style="margin:16px 0;padding:12px 14px;background:#fff7ed;border-left:4px solid #fb923c;white-space:pre-wrap;">{{message_text}}</blockquote><p>Svar på denne e-posten for å svare kunden.</p>',
  ...
  (
    ...
    'support',
    'shared',
    '[{{thread_id}}] Svar på: {{subject_line}}',
    '[{{thread_id}}] Reply: {{subject_line}}',
    '<h2>Nytt svar fra Tinglum Gard</h2><p>Hei {{customer_name}},</p><p>Du har fått et svar fra {{admin_name}}.</p><blockquote style="margin:16px 0;padding:12px 14px;background:#ecfeff;border-left:4px solid #22d3ee;white-space:pre-wrap;">{{reply_text}}</blockquote><p>Du kan svare direkte på denne e-posten, eller gå til <a href="{{portal_url}}">{{portal_label}}</a>.</p>',
  ...
  (
    ...
    '<h2>Kundesvar (e-post)</h2><p><strong>Fra:</strong> {{customer_name}} ({{customer_phone}})<br/><strong>E-post:</strong> {{customer_email}}</p><p>{{order_number}}</p><p><strong>Emne:</strong> {{subject_line}}</p><blockquote style="margin:16px 0;padding:12px 14px;background:#eff6ff;border-left:4px solid #60a5fa;white-space:pre-wrap;">{{reply_text}}</blockquote><p>Svar på denne e-posten direkte for å svare kunden.</p>',
  ...
  (
    ...
    '<h2>Kundehenvendelse</h2><p><strong>Kunde:</strong> {{customer_name}}<br/><strong>E-post:</strong> {{customer_email}}<br/><strong>Telefon:</strong> {{customer_phone}}</p><p><strong>Ordre:</strong> {{order_number}}</p><p><strong>Ordredetaljer:</strong></p><blockquote style="margin:16px 0;padding:12px 14px;background:#eff6ff;border-left:4px solid #60a5fa;white-space:pre-wrap;">{{order_details}}</blockquote><p><strong>Melding:</strong></p><blockquote style="margin:16px 0;padding:12px 14px;background:#f5f3ff;border-left:4px solid #a78bfa;white-space:pre-wrap;">{{message_text}}</blockquote><p>Svar kunden på {{customer_email}}.</p>',
  ...
  (
    ...
    '<h2>Melding mottatt</h2><p>Hei {{customer_name}},</p><p>Vi har mottatt henvendelsen din om ordre <strong>{{order_number}}</strong>.</p><blockquote style="margin:16px 0;padding:12px 14px;background:#f4f4f5;border-left:4px solid #d4d4d8;white-space:pre-wrap;">{{message_text}}</blockquote><p>Vi kontakter deg snart på {{customer_email}} eller {{customer_phone}}.</p>',
  ...
  (
    ...
    '<h2>Egg er frigitt for bestilling</h2><p>Hei {{customer_name}},</p><p><strong>{{breed_name}}</strong> er nå tilgjengelig i uke {{week_number}} (levering {{delivery_date}}).</p><p>Vinduet for prioritet i ventelisten er {{reservation_window_minutes}} minutter.</p><p><a href="{{inventory_url}}" style="display:inline-block;background:#111827;color:#ffffff;text-decoration:none;padding:10px 16px;border-radius:8px;">Gå til bestilling</a></p>',
